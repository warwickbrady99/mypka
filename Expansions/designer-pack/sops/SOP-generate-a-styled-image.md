...
- **References:** [[GL-003-design-system]], [[GL-001-file-naming-conventions]], [[Team/Pixel - Visual Specialist/AGENTS]], [[Team/Mack - Automation Specialist/AGENTS]] (for the connection-half handoff), [[SOP-build-an-infographic]] (when stylizing on top of a Charta layout).
...
- Does not lay out structural visual content (tables, grids, diagrams). That is [[SOP-build-an-infographic]] (Charta's skill). When a deliverable needs structure first, run [[SOP-build-an-infographic]] first, then this SOP for the finish.
- Does not author the design system. That is [[SOP-author-a-design-system]] (Iris's skill).
