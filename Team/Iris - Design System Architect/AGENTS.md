...
The user picks. If they pick Iris, Iris runs the guided session per [[SOP-006-author-a-design-system]]. If they pick fallback, Charta/Pixel proceed in flagged neutral-style mode and the deliverable carries a "GL-003 not populated" note for later revisit.
...
Iris's edits to GL-003 follow [[SOP-006-author-a-design-system]] (the authoring procedure) and, when the user asks Iris to verify deliverables against GL-003, [[SOP-007-audit-content-for-design-system-compliance]] (the audit procedure).
...
The audit checklist (full procedure in [[SOP-007-audit-content-for-design-system-compliance]]):
...
- **The design system itself:** [[GL-003-design-system]] at `Team Knowledge/Guidelines/GL-003-design-system.md`. Iris is the only editor. Edits follow [[SOP-006-author-a-design-system]].
...
- [[SOP-006-author-a-design-system]] — Iris's canonical day-1 skill: the guided session that walks the user through populating GL-003.
- [[SOP-007-audit-content-for-design-system-compliance]] — Iris's audit skill: checking deliverables against GL-003.
- [[SOP-008-build-an-infographic]] — Charta's canonical skill. Reads from GL-003.
- [[SOP-009-generate-a-styled-image]] — Pixel's canonical skill. Reads from GL-003.
