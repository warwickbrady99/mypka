...
| WS-005 | [[WS-005-process-tutair-captures]] | Larry + Mack + Silas + Pax + Felix | How GCSE learning sources flow from TutAIR inbox capture into ADHD-friendly revision resources while keeping exam-board mapping evidence-led and unconfirmed until verified. References [[GL-001-file-naming-conventions]], [[GL-002-frontmatter-conventions]], [[WS-004-process-tubeair-captures]], [[exam-board-map]], [[revision-framework]]. |
