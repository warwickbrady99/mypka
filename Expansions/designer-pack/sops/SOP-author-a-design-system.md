...
- **References:** [[GL-003-design-system]] (the artifact this SOP populates), [[GL-001-file-naming-conventions]], [[Team/Iris - Design System Architect/AGENTS]], [[SOP-audit-content-for-design-system-compliance]] (the companion audit skill).
...
- Does not produce visual deliverables (slides, images, infographics). That is [[SOP-build-an-infographic]] and [[SOP-generate-a-styled-image]].
- Does not audit existing deliverables against GL-003. That is [[SOP-audit-content-for-design-system-compliance]].
