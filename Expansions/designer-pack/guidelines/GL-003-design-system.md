...
- **If a section the task needs is empty (still showing `<placeholder>` values),** the agent does not improvise. Two paths:
  1. Route to Iris via [[SOP-author-a-design-system]] to populate.
...
- **Audit cadence.** Iris runs [[SOP-audit-content-for-design-system-compliance]] when the user requests it, when a token is added, or when drift is suspected. The audit names violations; the user decides which to fix.

## References

- [[SOP-author-a-design-system]] — the procedure for populating or extending this Guideline.
- [[SOP-audit-content-for-design-system-compliance]] — the procedure for verifying deliverables against this Guideline.
- [[SOP-build-an-infographic]] — Charta's skill; reads from this Guideline.
- [[SOP-generate-a-styled-image]] — Pixel's skill; reads from this Guideline.
